...
serviceNameLo="${project.artifactId}"                  # service name with the first letter in lowercase
serviceName="${project.artifactId}"                    # service name
serviceJar="${project.artifactId}-${project.version}"  # full name of jar file
...
javaArgs="-Xms256m -Xmx512m -server -jar $applDir/$serviceJar.jar"      # arguments for Java launcher
